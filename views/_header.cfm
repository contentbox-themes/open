	...
	<cfif cb.isHomePage()>
		<div class="header-row-2">
			<div class="title">
				<cfif cb.themeSetting( 'headerLogo', '' ) is "">
					<h1>
						<a href="#cb.linkHome()#" class="brand" title="#cb.siteTagLine()#" data-toggle="tooltip">
							<strong>#cb.siteName()#</strong>
						</a>
					</h1>
				<cfelse>
					<h1 class="brand-h1-img">
						<a href="#cb.linkHome()#" class="brand brand-img" title="#cb.siteTagLine()#" data-toggle="tooltip"><img src="#cb.themeSetting( 'headerLogo' )#" alt="#cb.siteName()#"></a>
					</h1>
				</cfif>
				#cb.siteTagLine()#
			</div><!--- end title --->
